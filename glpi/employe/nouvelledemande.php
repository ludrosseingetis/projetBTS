                        ...
                        <div class="form-container">
                            <form method="POST" action="nvdemande.php">
                                ...
                                <div class="form-groupc">
                                    ...
                                    <?php echo '<input type="text" id="id_user" name="id_user" class="form-control" readonly value="' . $_SESSION['id'] . '" placeholder="' .$_SESSION['log'] . '"></input>'; ?>
                                ...
                                <div class="form-groupc">
                                    ...
                                    <select id="id_equipe" name="id_equipe" class="form-control" class="gris">
                                        <option value='7'class="gris">équipe hotline</option>
                                </select>
                                </div>
                                <div class="form-group">
