...
if (isset($_SESSION['id'])) {
    try {
        ...
        $requete2 = "SELECT * from user where id_user = $code";
       ...
       ?><br><tr> <td><h3>Id de l'utilisateur</h3></td> <td><h3> Nom de l'utilisateur</h3></td><td><h3>Prenom de l'utilisateur</h3></td><td><h3>Date de naissance</h3></td><td><h3>Numéro de téléphone</h3></td><td><h3>Importance</h3></td><td><h3>Matériel</h3></td><td><h3>Modifier</h3></td><?php 
       ...
       while($enreg = $resultat->fetch(PDO::FETCH_ASSOC))
        ...
        <tr>
            ...
            <td>
            <?php echo "<a href='materiel.php?num=".$enreg['id_user']."' style='color:blue'>Voir Matériel</a>" ?>
            </td>
            <td>
  
            <?php echo "<a href='modifieruser.php?num=".$enreg['id_user']."' style='color:blue'>supprimer</a>" ?>
