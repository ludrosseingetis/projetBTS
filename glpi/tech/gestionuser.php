...
<body>
        ...
        <button class="dropdown-btnc">Gestion des utilisateurs
            <i class="fa fa-caret-down"></i>
          </button>
        <div class="dropdown-containerc">

        <a href=""><input type="button" value="Vue d'ensemble des utilisateurs" class="demandeekpc"></a>
...
if (isset($_SESSION['id'])) {
    try {
       ...
       <div class="gg">
       <form method="POST">
       <select name="sel" value="vide">
       <option>Employé</option>
       <option>Technicien</option>
       <option>Directeur</option>
       <option selected="selected">Tout</option>
       </select>
       <button type="submit" value="valider" placeholder="valider">Valider</button>
    </div>
    <style>
        .gg {
            float:right;
...
if ($test == 'Employé'){
$requete2 = "SELECT * FROM user where grade = 'Employe'";
}
else if ($test == 'Technicien'){
$requete2 = "SELECT * FROM user where grade = 'Technicien'";
}
else if ($test == 'Directeur'){
$requete2 = "SELECT * FROM user where grade = 'Directeur'";
}
else if ($test == 'Tout'){
...
$resultat= $pdo->query($requete2);
        ...
        <br><tr> <td><h3>Id de l'utilisateur</h3></td> <td><h3>Nom de l'utilisateur</h3></td><td><h3>Prenom de l'utilisateur</h3></td><td><h3>Date de naissance</h3></td><td><h3>Numéro de téléphone</h3></td><td><h3>Grade</h3></td><td><h3>ID Technicien</h3></td><td><h3>Modifier</h3></td><?php
        ...
        <tr>
            ...
            <td>
                <?php
                echo $enreg["prenom_user"];
                ?>
            </td>
            <td>
                <?php
                echo $enreg["date_naissance"];
                ?>
            </td>
            <td>
                <?php
            ...
            <td>
            <?php echo "<a href='infouser.php?num=".$enreg['id_user']."' style='color:blue'>En savoir plus</a>" ?>
        </td>
