...
if (isset($_SESSION['id'])) {
    try {
       ...
       <form
       <select name="sel">
        <a href="test.php"><option> Employé </option></a>
       ...
       <button type="submit" value="valider" placeholder="valider">Valider</button>
        ...
        <br><tr> <td><h3>Id de l'utilisateur</h3></td> <td><h3>Nom de l'utilisateur</h3></td><td><h3>Prenom de l'utilisateur</h3></td><td><h3>Date de naissance</h3></td><td><h3>Grade</h3></td><td><h3>Id Technicien</h3></td><td><h3>Etat</h3></td><td><h3>Modifier</h3></td><?php 
