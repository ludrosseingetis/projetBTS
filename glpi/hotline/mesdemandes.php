...
<body>
        ...
        <style>.mothaut{
            ...
            <a href="demandes.php"><input type="button" value="Nouvelle Demande" class="demandeekp"></a>

            <a href=""><input type="button" value="Mes Demandes" class="demandeekpc"></a>
        ...
        $idtech = $_SESSION['idtech'];
            $requete =  "SELECT * FROM tickets where `etat` = 'en attente' ";
...
if (isset($_SESSION['id'])) {
    try {
        ...
        $requete2 = "SELECT * FROM tickets where etat = 'en attente' and etat <> 'Resolu'";
        
        $resultat= $pdo->query($requete2);
       ?><br><n>Bienvenue Hotline numéro </n><?php echo $idtech;
...
<?php
 ...
 $idtech = @$_POST['id_tech'];
 $importance = @$_POST['importance'];
 $etat = @$_POST['etat'];

    $requeteadd = "INSERT INTO tickets Values ('',$titre,$commentaire,$iduser,$idtech,$importance,$etat,NULL)";

    $resultatadd= $pdo->query($requeteadd);
