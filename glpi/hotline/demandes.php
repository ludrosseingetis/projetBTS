                        ...
                        <div class="form-container">
                            <form method="POST" action="nvdemande.php">
                                ...
                                <div class="form-group">
                                    <label for="nom_ticket">Nom du Ticket:</label>
                                    <input type="text" id="nom_ticket" name="nom_ticket" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-groupc">
                                    ...
                                    <?php echo '<input type="text" id="id_user" name="id_user" class="form-control" readonly value="' . htmlspecialchars($_SESSION['id']) . '" placeholder="' . htmlspecialchars($_SESSION['log']) . '"></input>'; ?>


                                </div>
                                <div class="form-groupc">
                                    <label for="id_technicien">ID Technicien:</label>
                                    <input type="text" id="id_technicien" name="id_technicien" class="form-control" readonly value="0">
                                </div>
                                <div class="form-groupc">
                                    <label for="importance">Importance:</label>
                                    <select id="importance" name="importance" class="form-control">
                                        <option>-- Choissisez l'Importance du ticket --</option>
                                ...
                                <div class="form-groupc">
                                    <input type="text" id="etat" name="etat" class="form-control" class="gris" readonly placeholder="En Attente" value="En Attente">
                                </div>
                                <div class="form-groupc">
                                    <label for="id_equipe">Équipe:</label>
                                    <select id="id_equipe" name="id_equipe" class="form-control" class="gris">
                                        <option value='5'class="gris">équipe hotline</option>
                                </select>
                                </div>
                                <div class="form-group">
